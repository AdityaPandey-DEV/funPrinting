...
export const LocationIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M12 0C7.589 0 4 3.589 4 8c0 4.245 7.273 15.307 7.583 15.775a.996.996 0 0 0 1.834 0C13.727 23.307 21 12.245 21 8c0-4.411-3.589-8-9-8zm0 11c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z" />
    </svg>
  );
};
...
export const PhoneIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M20.487 17.14l-4.065-3.696a1.001 1.001 0 0 0-1.391.043l-2.393 2.461c-.576-.11-1.734-.471-2.926-1.66-1.192-1.193-1.553-2.354-1.66-2.926l2.459-2.394a1 1 0 0 0 .043-1.391L6.86 3.513a1 1 0 0 0-1.391-.087l-3.17 2.584a1 1 0 0 0-.29.649c-.015.25-.301 6.169 4.291 10.76 4.006 4.006 9.429 4.299 10.667 4.299.202 0 .326-.006.359-.008a.992.992 0 0 0 .648-.291l2.584-3.17a.997.997 0 0 0-.085-1.4z" />
    </svg>
  );
};
...
export const MoneyIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    ...
    >
      ...
      <path d="M12.5 13.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5S11 11.17 11 12s.67 1.5 1.5 1.5z" />
    </svg>
  );
};
...
export const RocketIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M9.19 6.35c-2.5 2.5-3.78 5.87-3.96 9.24l-2.23 2.23c-.39.39-.39 1.02 0 1.41l2.83 2.83c.39.39 1.02.39 1.41 0l2.23-2.23c3.37-.18 6.74-1.46 9.24-3.96 3.12-3.12 4.07-7.68 2.82-9.93s-6.81-.3-9.93 2.82zM12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-2 19l-2-2 2-2 2 2-2 2zm6-6l-2-2 2-2 2 2-2 2z" />
    </svg>
  );
};
...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58a.49.49 0 0 0 .12-.61l-1.92-3.32a.488.488 0 0 0-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94L14.4 2.81a.484.484 0 0 0-.78 0l-1.54 2.6c-.59.24-1.12.56-1.62.94l-2.39-.96a.488.488 0 0 0-.59.22L2.74 8.87c-.16.28-.13.62.08.84l1.92 3.32c.21.22.55.29.84.08l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.3.3.52.6.52h3.84c.3 0 .55-.22.6-.52l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.29.21.64.14.84-.08l1.92-3.32a.488.488 0 0 0-.08-.84l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z" />
    </svg>
  );
};
...
export const PaperclipIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M16.5 6v11.5c0 2.49-2.01 4.5-4.5 4.5s-4.5-2.01-4.5-4.5V5c0-1.66 1.34-3 3-3s3 1.34 3 3v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V5c0-2.76-2.24-5-5-5S5.5 2.24 5.5 5v12.5c0 3.87 3.13 7 7 7s7-3.13 7-7V6h-1.5z" />
    </svg>
  );
};
