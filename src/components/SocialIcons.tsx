...
export const MoneyIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zm-8-2c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm4-8H8v6h8V8z" />
    </svg>
  );
};
...
export const RocketIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M2.81 14.12l-2.12-2.12L12 2l11.31 10-2.12 2.12L12 6.24 2.81 14.12zM12 22l-3-3 3-3 3 3-3 3z" />
